...
# Delete one region with filter 
#for region in $(aws ec2 describe-regions --filters "Name=region-name,Values=eu-west-1" | jq -r .Regions[].RegionName); do

# DELETE ALL DEFAULT VPCs ACROSS ALL REGIONS
